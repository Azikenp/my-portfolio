...
import hashnode from '../assets/brand-icon-white.png'


const About = () => {
  return (
    <div className=' py-[2rem] md:py-[1.82rem] px-[0.85rem] md:px-[2.85rem] lg:px-[3.85rem] pt-[4rem] pb-[4rem] border-b-[1px] border-[#f0f8ffe7]'>
